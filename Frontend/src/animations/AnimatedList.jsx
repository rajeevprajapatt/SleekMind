...
const AnimatedList = ({
    ...
    return (
        <div className={`relative w-full ${className}`}> {/* full width of parent */}
            <div
                ref={listRef}
                className={`max-h-[45vh] sm:max-h-[50vh] md:max-h-[60vh] lg:max-h-[70vh] overflow-y-auto ${displayScrollbar
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        <div
                            className={` w-full bg-[] rounded-lg  transition-colors duration-200 ease-in-out ${itemClassName}`}
